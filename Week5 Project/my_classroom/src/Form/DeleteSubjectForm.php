...
class DeleteSubjectForm extends ConfirmFormBase{
  ...
  public function getCancelUrl(){
    return new Url('my_classroom.my_classroom_controller_subject_listing');
  ...
  public function submitForm(array &$form, FormStateInterface $form_state){
    ...
    $query->delete('subject_table')->condition('sub_id',$this->id)->execute();
